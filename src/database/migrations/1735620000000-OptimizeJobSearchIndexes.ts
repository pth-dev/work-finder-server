...
export class OptimizeJobSearchIndexes1735620000000
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS idx_jobs_search_location_status
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS idx_jobs_type_location_active
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS idx_jobs_company_active_recent
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS idx_jobs_featured_by_saves
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS idx_jobs_recent_not_expired
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS idx_companies_search_verified
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS idx_jobs_application_stats
      ON job_posts(job_id, application_count, save_count, view_count)
    `);

    // Add partial index for expired jobs cleanup
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS idx_jobs_expired_cleanup
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_jobs_search_location_status`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_jobs_salary_range_active`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_jobs_type_location_active`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_jobs_company_active_recent`,
    );
    await queryRunner.query(`DROP INDEX IF EXISTS idx_jobs_featured_by_saves`);
    await queryRunner.query(`DROP INDEX IF EXISTS idx_jobs_recent_not_expired`);
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_companies_search_verified`,
    );
    await queryRunner.query(`DROP INDEX IF EXISTS idx_jobs_application_stats`);
    await queryRunner.query(`DROP INDEX IF EXISTS idx_jobs_expired_cleanup`);
  }
}
